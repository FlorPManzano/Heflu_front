            ...
            <div className=" flex flex-col gap-y-4 items-center">
                {bookings && bookings.length > 0 ? (
                    bookings.map((booking) => (
                        <article
                            key={booking.id}
                            className="flex gap-6 p-4 border border-primary/20 rounded-2xl shadow-md max-w-[760px]"
                        >
                            <img
                            ...
                            <div>
                                ...
                                <div className="flex justify-end items-end">
                                    <button className="text-violet-700 font-medium text-sm rounded-lg mr-4 hover:underline transition duration-300 ease-in-out capitalize">
                                        Cancelar
                                    </button>
                                    <button className="bg-violet-700 border border-violet-700 font-normal text-white px-2 py-1 text-sm rounded-lg hover:shadow-lg transition-shadow duration-300 ease-in-out">
                                        Aceptar
                                    </button>
                                </div>
                            </div>
